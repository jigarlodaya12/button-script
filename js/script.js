...
var IM = function() {
  ...
  function getPayButtonCard(element, checkoutButtonData) {
    ...
    element.outerHTML = checkoutButtonData['layout']
      ? `<div class="im-new-checkout-layout layout-${randomId}">
  ...
  /**
   * Converts a[rel="im-new-checkout"] to button which opens a modal
   */
